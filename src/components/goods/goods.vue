<template>
    <div class="goods">
        <div class="meun-wrapper" ref="meunWrapper">
          <ul>
            <li v-for="(item,index) in goods" class="meun-item" :class="{'current':currentIndex === index}" @click="selectMenu(index)">
              <span class="text border-transform">
        ...
        <div class="foods-wrapper" ref="foodsWrapper">
          <ul>
            <li v-for="item in goods" class="food-list food-list-hook" >
              ...
              <ul>
                <li v-for="food in item.foods" class="food-item border-transform" @click="selectFood(food,$event)">
                  <div class="icon">
                    <img width="54" :src="food.icon">
                  </div>
                  <div class="content">
        ...
        <food :food="selectedFood" v-on:cartadd="cartaddEvent" ref="food"></food>
    </div>
</template>
